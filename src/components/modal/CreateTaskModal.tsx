...
import { isOpenCreateTaskModalAtom } from "~/store";

export default function CreateTaskModal() {
  const setIsOpenCreateTaskModal = useSetAtom(isOpenCreateTaskModalAtom);
    ...
    <div className="w-full flex justify-center items-center fixed backdrop-blur-lg top-0 min-h-screen">
      <div className="bg-white drop-shadow-lg w-[420px] p-4 rounded-lg">
        <div className="w-full flex justify-between items-center">
          ...
          <button type="button" onClick={() => setIsOpenCreateTaskModal(false)}>
